...
fpath='F:/Kaggle_NCFM/dataset/train/train/ALB/img_00010.jpg'   
im = cv2.imread(fpath)
org = im
...
if best_size > 0:
    ...
    show("areas",org)
    path='F:/code/whale_detector-master/try/'   
    cv2.imwrite(path+"mask-areas.jpg",im)
    cv2.imwrite(path+"areas.jpg",org)
cv2.waitKey(45000)
