...
if __name__ == '__main__':
    ...
    num_folds = 3
    models = []
    model1 = load_model('F:/code/model_res/model3-PIL2-CNN2/1.h5')
    models.append(model1)
    model2 = load_model('F:/code/model_res/model3-PIL2-CNN2/2.h5')
    models.append(model2)
    model3 = load_model('F:/code/model_res/model3-PIL2-CNN2/3.h5')
