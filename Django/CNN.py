...
def pred(model_path,image_path):
    np.random.seed(7)
    ...
    o_im = load_img(os.path.join(image_path))
...
#########################################################################
model_path="F:/code/model_res/model2-PIL1.0-CNN1.0/model2_epoch_10.h5"
image_path="F:/code/dataset1/test1/13.jpg"
df = pred(model_path,image_path)
print(df)
